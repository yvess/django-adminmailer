...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.test_email'
        db.add_column(u'adminmailer_message', 'test_email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.test_email'
        db.delete_column(u'adminmailer_message', 'test_email')
