...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'adminmailer_message', (
            ...
            ('recipient_list', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bzperson.BZPersonList'], null=True)),
        ...
        db.send_create_signal(u'adminmailer', ['Message'])


    def backwards(self, orm):
        # Deleting model 'Message'
        db.delete_table(u'adminmailer_message')


    models = {
        u'adminmailer.message': {
            ...
            'recipient_list': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['bzperson.BZPersonList']", 'null': 'True'}),
        ...
        u'bzperson.bzperson': {
            'Meta': {'ordering': "(u'vorname', u'name')", 'object_name': 'BZPerson'},
            'geburtsdatum': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'sv_nummer': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'vorname': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        u'bzperson.bzpersonlist': {
            'Meta': {'object_name': 'BZPersonList'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'members': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['bzperson.BZPerson']", 'symmetrical': 'False'}),
